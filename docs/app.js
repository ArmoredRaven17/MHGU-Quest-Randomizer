...
(function () {
  ...
  const COLORS = [
    ...
    ["Tetsucabra","#68360D"], ["Agnaktor","#B5590D"],  // orange ~30°
    ["Tigrex","#574916"],["Rajang","#9C8328"],                       // yellow ~47°
    ["Deviljho","#0B570F"],["Rathian","#39993E"],    // green ~124°
    ...
    ["Mizutsune","#D4358C"],["Congalala","#C8679D"],                                        // pink ~327°
    ["Duramboros","#5a411f"],["Diablos","#997c54"],
    ["Barroth","#835A32"],["Bulldrome","#B17A47"], 
    ["K. Daora","#505358","Kushala Daora"],["Valstrax","#7C879B"],  // neutrals dark→light
  ...
  function renderResult(quest, type) {
    ...
    $("r_keyPill").classList.toggle("hidden", !quest.Key);
  ...
  function loadFilters() {
    ...
    if (d.t) {
      $("f_keysOnly").checked = !!d.t.keysOnly;
